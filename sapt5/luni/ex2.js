...
var personStrUpp = personKeys.toString().toUpperCase();
console.log(personStrUpp);
var newVar = personStrUpp;
console.log(newVar);
var newVarLow = newVar.toLowerCase();
console.log(newVarLow);
var result = newVarLow + " reprezinta descrierea unei persoane";
console.log(result);
//Ex3
...
var classes = {
    name : "Math",
    hours: 2,
    smthAboutClasses: function () {
      console.log("It is horrible to do " + this.name + " for " + this.hours + " hours");
    }
  };
  classes.smthAboutClasses();
//Ex4 
